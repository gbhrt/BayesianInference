...
vector<int> heuristic_order(BayesianNetwork & BayesNet, vector<int> free_vars)//find a variable elimination order
{
	//create a undirected graph from the bayesian network - a neighbor list
